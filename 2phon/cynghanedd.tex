...
give insight into the phonetics of \gls{mw} stop consonants
 ...
 in \mw{letty} `lodging' < \mw{lled + dy} < \mw{ty} `house' and \mw{d
   + h} becomes \mw{tt} in \mw{atteb} `reply' < \mw{ad + heb}.
...
% Here, \mw{Crist} alliterates with \mw{-c Croc} in the next line. The Modern Welsh respelling lenites \mw{Croc}, presumably as object lenition, which may not yet have existed in this period~\parencite[55-57]{van_development14}.
...
The most doubtful example is Example~\ref{duccroc}, which is speculatively lenited in the \gls{mow} standardised text; presumably because object lenition is held to have caused lenition following \mw{duc} `brought'. However, object lenition following this type of verb is a comparatively late \gls{mw} phenomenon~\parencite[55-57]{van_development14}, so reading lenition here is probably anachronistic. 
...
\end{mwl}
In Example~\ref{alltuddrud}, radical \mw{drud} `foolish' alliterates with lenited \mw{dreigyl} `inhabits'. In Example~\ref{kymrawtdreic},  radical \mw{dreic} alliterates with lenited \mw{drwy} in the next line, or alternatively with \mw{Drindod}. Note, however, \mw{drwy} is not lenited as the result of any morphological process here. Rather, a lenited version exists side by side with radical \mw{trwy}. Under \gls{petr}, the phonetics may work out differently than they do under \gls{morphophonlen}\footnote{Cf.\  Subsection~\ref{sec:petrification}.}. 
