...
Examples~\ref{torchawchael} to \ref{ghyt-hoet} contain counterexamples to the claim that \gls{D}+\mw[]{h}=\xT. However, each of these examples are problematic in their on way so that  no dependable counterexamples remain to the proposition that \gls{D}+\mw{h}=\xT.
