...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \draw[->] (3xd) -- (4d);
    %%% OPPOSITIONS
    \draw[<->,dashed, bend left = 30] (0t) to node[midway,font=\footnotesize,above]{±\gls{vot}} (0d);
    \draw[<->,dashed, bend left = 30]
    ...
    \draw[<->,dashed, bend left = 30]
    (4t) to node[midway,font=\footnotesize,above]{±\gls{vot}} (4d);
    %%% EXPLANATION
    \node[%
