...
Etymological \gls{D} is consistently written as \ow{p, t, c} when it represents a word-medial voiced geminate. This confirms the hypothesis by \textcite{martinet_celtic_1952} that voiced geminates merged with lenited voiceless stops in an early stage due to the rarity of the former class\footnote{See Section~\ref{sec:martinet}}. Because it is the voiced geminates which were rare and the lenited voiceless stops which were common, I proposed that voiced geminates merged to the value of lenited voiceless stops, and not vice versa.
