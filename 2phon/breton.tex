...
\tqt{
  \begin{french}
   ...
   Le \textit{b} sera doux dans \textit{abred, (abr\c{ē}d}, << de bonne heure >>, ais fort dans \textit{ha breman (a bbr\`{\c{ē}}m\~{a})}, << et \`{a} pr\'{e}sent >>, parce que \textit{ha}, r\'{e}duction de \textit{hag}, n'adoucit pas la consonne suivante […].
 \end{french}}{falchun_systeme_1951}{64} 
