...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \node[below=1.5cm of 2l,align=left](3l){%
      Redundant\\voicing\\of \gls{l}\gls{C}};
...
% \todo[inline]{Also, loss of length due to fricativisation in lenited voiced stops need not be contemporaneous with voicing of lenited voiceless stops. This is unlikely, because it is shared between Goidelic and Brittonic. The two-stage development considered by Loth et al.\ is wrong because it equals lenition of \gls{T} with voicing, but we can assume \lT\ was distinct from \xT\ through length at first in both Goidelic and Brittonic. Thus, we cannot say that Brittonic lenition as a whole happened in two stages, but what we can say is that the realisation of lenited \gls{D} turned into fricatives at a different date than the realisation of lenition of \gls{T} became voiced stops.}
...
\todo[inline]{The rest of this Chapter will be:
  \begin{itemize}
