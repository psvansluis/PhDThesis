...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \draw[<->,dashed, bend left = 50] (2xt) to node[midway,font=\footnotesize,above]{±length} (2lt);
    \draw[<->,dashed, bend left = 50] (2lt) to node[midway,font=\footnotesize,above]{±voice\vphantom{g}} (2xd);
    \draw[<->,dashed, bend left = 50] (3xt) to node[midway,font=\footnotesize,above]{±voice\vphantom{g}} (3lt);
    \draw[<->,dashed, bend left = 50] (3lt) to node[midway,font=\footnotesize,above]{±length} (3xd);
    %%% EXPLANATION
    \node[%
    below=8.5cm of topl,
    font=\footnotesize,
