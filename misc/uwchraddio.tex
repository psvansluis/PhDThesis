...
Yn fy nhraethawd meistr, darganfyddais y patrwm o beidio i ddangos treiglad \mw{p, t, c} ar ôl -\mw{ei} ac \mw{oes} ym mhedair cainc y Mabinogi a Chulhwch ac Olwen~\autocite{van_development14}, fel y gallwch weld yn Enghraifft~\ref{ei}. 
...
In my Master's thesis, I discovered a pattern of failing to show lenition of \mw{p, t, c} following \ei\ and \mw{oes} in the four branches of the Mabinogi, and in Culhwch ac Olwen~\autocite{van_development14}, as you can see in Example~\ref{eieng}.
