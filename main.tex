...
\setmainfont[
RawFeature={%
  +mgrk;% Upright Greek for IPA
  +liga;+clig;+ccmp;+tlig;+rlig;+calt;+kern;
  +onum;% Old-style numerals
  +ss01;% Nordic letter shapes for IPA-friendly edh and thorn
  +falt},
...
\usepackage{setspace}
\setstretch{1.45} %Enable to receive one-half spacing
...
% \includeonly{3orth/orthintro,3orth/issues,3orth/brut,3orth/laws,3orth/dewi,3orth/orconclus}
\begin{document}
\input{structure}
