...
\begin{tabular}{@{}ll*{7}{d}@{}}
  \toprule
  \multirow{2}{*}{\tch{Text (IW)}} & \multirow{2}{*}{\tch{Table}} & \tchhh{Voiceless stops} & \tchhh{Not voiceless stops} & \multirow{2}{*}{\tch{Total (\%)}}\\
                                   &  & \tch{rep.} & \tch{not rep.} & \tch{(\%)} & \tch{rep.} & \tch{not rep.} & \tch{(\%)} \\ \midrule
