...
The manuscript with the siglum \gls{sA} is  \gls{nlw}, Peniarth MS 29, also known as the Black Book of Chirk. It is dated to the mid-thirteenth century and thought to have been produced in the Arfon region~\autocite[171]{RussellScribalcompetenceThirteenthcentury1995}.  Several scribes may be identified in the manuscript, but the material used here all comes from Hand D and a few lines by Hand E~\autocite[133--134]{RussellScribalcompetenceThirteenthcentury1995}. Hand D's orthography is peculiar for the thirteenth century in that he writes /ə/ with \mw[]{a}, and he has many variant spellings for /θ/, such as \mw[]{s, h, sh, ht, sth}. Hand E's work seems to be `the most regular and consistent of all scribes in [\gls{sA}]'~\autocite[152]{RussellScribalcompetenceThirteenthcentury1995}. The irregular spelling of dental fricatives, along with some other orthographical irregularities, suggests that \gls{sA}'s exemplar was written in \gls{ow} orthography~\autocite[169]{RussellScribalcompetenceThirteenthcentury1995}. 
...
\todo[inline]{perhaps it is better to have this info as part of the conclusion at the end of this chapter.}
