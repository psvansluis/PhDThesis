...
Finally, place-names in both Wales and Brittany have undergone spirantisation \eg \mow{Ma-thafarn} in Wales and \mob{Poher} < \lat{pagus} + \ob{kaer} in Brittany.
...
\todo[inline]{The list below makes for such dry reading that it is perhaps better placed in the appendix.}
