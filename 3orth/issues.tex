...
\item negative particles \mw{ny, na}, affirmative particles \mw{neu, ry}, and prefixes \mw{go-, di-, dy-}, \etc;
\item conjunction \mw[if]{o};
\item \mw[where?]{cw}.
\end{itemize}
The same environments also cause spirantization in Breton for the most part. Additionally,  spirantization is found in \gmob[Easter Sunday]{Sul Fask}, and other close compounds containing a single fixed expression.
