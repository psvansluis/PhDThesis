...
Still, exceptions exist, \eg \gmow[together]{i gyd} is written as  one word in \gls{mw}: \mw{ygyt}.
...
A similar morphological relationship between phonemes may not be posited for word-medial and word-final consonants, \eg the existence of the word \mw{tad} does not imply the existence of the word \mw{**tat}.
