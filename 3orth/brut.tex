...
The \gls{p44} translation of the \mw{Brut} is roughly as old as the \gls{ll1} one, although \textcite[85]{Rus_Orthography93} argues on orthographic grounds that it is written before \gls{ll1}. 
...
This means that writing \mw{b, d, g} for \lT\ had already been invented by the mid-thirteenth century.
...
Lenition of voiceless stops was generally not written in the early thirteenth century, but it was not unfamiliarity with the concept of using \mw{b, d, g} for earlier  \mw{p, t, c} that kept them from writing lenition as such.
