...
\end{welsh}%
\footnote{These translators are not slavish to the Latin text any more
  than typical translators of the medieval
  period. [\dots]
...
Another point when dealing with translations is that the language of the original Latin seeps through into the grammar of the Welsh.
...
Here, I compare and contrast the manuscript witnesses of \mw{Brut y Brenhinedd} chosen for analysis.
...
\tqt{
  \begin{welsh}
Fe'i  cyfieithwyd [yr \textit{Historia}] deirgwaith yn  y drydedd ganrif ar ddeg, ac ymddengys fod dau o'r fersiynau hyn, sef
...
\Textcite{lewis_brut_1942} \todo{page?} states that \gls{p44} and \gls{ll1} are based on a common original translation,
...
In other words: non-representation of lenition (and thus maintaining the original \mw{g}) served to indicate that  \mw{\cw} between two consonants was not syllabic.
