...
These examples are few and far between, but essential, because they show that lenition of voiceless stops could be represented. This means that experiments in writing \mw{b, d, g} for \lT\ were conducted in the mid-thirteenth century, but widespread implementation was some way off still. It seems that representing \lT\ with \mw{b, d, g} was not impossible at this stage, but was deemed inappropriate somehow.

\subsection{Lenition in \acrshort{bd}}
\label{sec:lenition-acrshortbd-}
In \gls{bd}, the rule is that lenition is not represented for \mw{p, t}, and that it is represented for \mw{c}.
...
Table~\ref{tab:exspellltbd} shows the two instances of orthographically represented lenition of \mw{p}, as well as every instance where lenited \mw{c} is not orthographically represented.
...
Its status as a personal namemay be of influence. Even native \gls{mw} personal names are sometimes not mutated; \mw{llyr} is found unlenited following \mw[fort]{caer} twice, showing that this exception is not related to the initial consonant of the name.
...
In the end, non-lenition may be a purely southern dialectal feature, and does not constitute an exception in the orthography of lenition.
