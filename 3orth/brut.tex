...
Geoffrey of Monmouth's Latin is generally straightforward, and his vocabulary and grammar do not generally give any trouble~\autocite[lxxvi]{GeoffreyofMonmouthHistoryKingsBritain2009}.
...
\footnote{These translators are not slavish to the Latin text any more than typical translators of the medieval  period. [\dots]
  Some details are changed, or some sentences are added in order to connect the history with other sources.}}{RobertsTestunauHanesCymraeg1974}{290}
...
}{RobertsTestunauHanesCymraeg1974}{289}
...
\Textcite{RobertsTestunauHanesCymraeg1974}  notes that these three translations  are similar in terms of how well they are translated.  
\tqt{
  \begin{welsh}
...
}{RobertsTestunauHanesCymraeg1974}{288--289}
...
However, when the methods of translation between these three versions are compared, some differences may be identified \autocite{RobertsTestunauHanesCymraeg1974}.
...
}{RobertsTestunauHanesCymraeg1974}{292--293}
...
\Textcite[xix]{LewisBrutDingestow1942} states that \gls{p44} and \gls{ll1} are based on a common original translation, undoubtedly because the \gls{ll1} manuscript contains a fragment of the \gls{p44} translation, but according to \textcite[xliii--xliv]{RobertsAstudiaethdestunoltri1969}  they are based on separate translations.
I analysed lenition on pages 23 to 28.

\Gls{bd} is found in the following manuscript: \gls{nlw} MS 5266.
It is dated to the end of the thirteenth century~\autocite[xliii]{RobertsAstudiaethdestunoltri1969}.
An edition of this text is prepared by \textcite{LewisBrutDingestow1942}.
...
It dates from the mid-fourteenth century according to~\textcite[xlv]{RobertsAstudiaethdestunoltri1969}, and from the second quarter of the same century according to \textcite[xviii]{JonesBrenhineddSaessonKing1971}.
...
\Textcite{RobertsTestunauHanesCymraeg1974} notes that the \gls{bcc} translation departs from the original in more ways than just summarizing, as it also incorporates other sources of history:
\tqt{
  \begin{welsh}
...
}{RobertsTestunauHanesCymraeg1974}{293}
...
or only in later texts~\autocite{vanSluisdevelopmentpostverballenition2014}, but
