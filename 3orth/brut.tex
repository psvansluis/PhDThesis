...
The writing of \mw{gynt} with \mw{g} may similarly point to petrified lenition, rather than morphophonemic lenition.
If so, this word constitutes a research exception.
\todo{Perhaps \mw{pa bryt} may be thought to behave similarly? Cf.~\gmow[how much]{faint} < \mow{pa faint}}
...
\todo[inline]{BD, with perhaps showing both lenited and unlenited for \mw{p} and \mw{c}, but not \mw{t}, because the latter has 0\% lenition, and thus no distribution to account for. Alternatively, show lenited \mw{p}, but unlenited \mw{c}.}
