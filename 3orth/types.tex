...
For example, \gmow[father]{tad} is a lexeme which has a form that is inflected for lenition: \mow{dad}. 
...
\todo[inline]{My editorial policy is to include petrified lenition and where lenition happens within compounds like `i gyd', but to mark them as research exceptions. However, I do not do this with personal pronouns such as \mw{mi/\w i}}