...
I suggest that clitic reduction  may in fact be considered the same development as the reduction of \pc{*tu} to \mw{dy} in \mw{dy-weddaf}, and that this development was distinct from lenition\footnote{%
  There is more evidence that \textcite[125]{schrijver_studies_1995} considers clitic reduction a form of lenition: `However, the act that the preposition always occurs in the lenited form, viz.\ Co.\ \textit{war}, MW \textit{ar} < \textit{*war} rather suggests that it was unstressed. [\dots] Since, as we have seen, the preposition was always lenited[\dots].'}.
