...
\newglossaryentry{provcon}
{
    ...
    description={A \gls{D}\mw{, h, or rh} that follows a \gls{D}, thereby provecting it to \gls{T}. It has two sub-types: \gls{doubcon} and \gls{aspcon}}
}
...
\newacronym[description={\textit{De Mensuribis et Ponderibus}, Oxford, Bodleian Library, Auctarium F.~4.~32}]{mp}{MP}{\textit{De Mensuribis et Ponderibus}}
\newacronym[description={\acrshort{nlw} Llanstephan MS 1}]{ll1}{Llan.\@\xspace}{Llanstephan MS 1}
